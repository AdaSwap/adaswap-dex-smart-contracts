...
describe("MasterAdaSwap", function(){
    ...
    it("21. testMasterAdaSwap: Deploy contracts", async function(){
    ...
    it("22. testMasterAdaSwap: prepare parametrs", async function(){
    ...
    describe('Creating pools with different allocation points',()=>{
        it('23. testMasterAdaSwap: Create pool with 2-4 users', async()=>{
            // first pool
        ...
        it('24. testMasterAdaSwap: Create another pool',async()=>{
            //second pool
    ...
    describe('Check rewards', async()=>{
        it('25.testMasterAdaSwap: Stop Reward counting',async()=>{
    ...
    describe('Fake operations',async()=>{
        ...
        it("26. testMasterAdaSwap: Should revert if not Onlyowner", async()=>{
            await expect( chef.connect(ALICE).add(15, lpToken.address, 0, rewarder.address))
            .to.be.revertedWith("Ownable: caller is not the owner");

        })

        it("27. testMasterAdaSwap: Should revert if 0 Address", async()=>{
            await expect( chef.connect('0x0').add(15, lpToken.address, 0, rewarder.address))
            .to.be.reverted;

        })

        it("28. testMasterAdaSwap: Should revert if fake account", async()=>{
